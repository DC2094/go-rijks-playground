...
//this will contain the struct for a 'collection / record' that will be
// used as a DTO between the API calls to rijks and storing in the DB.
// maybe rename me to records.go
